...
void Rook_Magic_Bitboards::init_attack_hash_tables()
{
         ...
         square_idx++)
    {
        ...
        // moves.
        // Note: This saves memory compared to a fixed size array [64][4096]
        // which assumes 4096 different configurations per square.
...
Bitboard
Rook_Magic_Bitboards::calculate_rook_attacks(const Square&   s,
