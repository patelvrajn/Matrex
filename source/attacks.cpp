...
Bitboard Attacks::get_bishop_attacks(const Square& s, const Bitboard& occupancy)
{
...
Bitboard Attacks::get_queen_attacks(const Square& s, const Bitboard& occupancy)
{
...
void Attacks::init_leaper_attacks()
{
         ...
         square_idx++)
    {
        ...
        m_king_attack_tables[square_idx] =
            mask_king_attacks(Square(square_idx));
    }
