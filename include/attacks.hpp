...
class Attacks {
 public:
  ...
  Bitboard get_bishop_attacks(const Square& s, const Bitboard& occupancy) const;
  Bitboard get_rook_attacks(const Square& s, const Bitboard& occupancy) const;
  Bitboard get_queen_attacks(const Square& s, const Bitboard& occupancy) const;

 private:
  static bool m_is_attack_tables_initialized;

  // Slider Attack Tables
  static Bishop_Magic_Bitboards m_bishop_attack_tables;
  static Rook_Magic_Bitboards m_rook_attack_tables;
